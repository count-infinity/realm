...
> current state of the project see `VISION.md` and `BACKLOG.md` in the
> repository root and the [design notes](engine_vision.md); for how
> things actually work, the [Concepts](../concepts/character-creation.md)
> and [Architecture](../architecture/overview.md) docs are authoritative.
